export const backendProducts = [
        ...
        designs: [
            {
                id: 1,
                name: "Angry Doberman",
                position: "center-top",      // ← Position string
                offsetX: 0,                  // ← Fine-tuning X
                offsetY: 40,                 // ← Fine-tuning Y
                url: "https://res.cloudinary.com/dd9tagtiw/image/upload/v1751967112/2234.preview_gd75zf.png",
                targetWidth: 80,             // ← Optional size
                targetHeight: 80
            },
            {
                id: 2,
    ...
    {
        id: 4,
        image: "https://res.cloudinary.com/dd9tagtiw/image/upload/v1753337618/gray-t-shirt-removebg-preview_msacqc.png",
        size: "L",
        color: "Gray",
        width: 300,

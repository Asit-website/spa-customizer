    ...
    return (
        <>
            <div className="bg-white rounded-lg border border-[#D3DBDF] w-80 h-fit max-h-[475px] overflow-y-scroll">
                ...
                <div className='flex flex-col gap-3 justify-between py-3 px-3'>
                    <h3 className='text-[14px] text-black font-semibold'>Arrange</h3>
                    <div className="flex items-center gap-7">
                        <img onClick={() => updateArrange("bringForward")} className='w-[20px]' src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1749508122/arrange-bring-forward_vigco4.png" alt="" />
                        <img onClick={() => updateArrange("bringToFront")} className='w-[20px]' src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1749508122/arrange-bring-to-front_povosv.png" alt="" />
                        <img onClick={() => updateArrange("sendBackward")} className='w-[20px]' src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1749508122/arrange-send-backward_buzw6f.png" alt="" />
                        <img onClick={() => updateArrange("sendToBack")} className='w-[20px]' src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1749508121/arrange-send-to-back_bcyzlu.png" alt="" />
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-3 py-3 px-3'>
                    <h3 className='text-[14px] text-black font-semibold'>Tools</h3>

                    <button className='border-[#D3DBDF] border rounded-md py-3 px-8  text-[14px] flex items-center justify-start gap-2'><span className='flex text-black items-center gap-2'><img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1749508617/circle-opacity_zvwbfk.png" alt="" /> Remove Background</span></button>
                    <button className='border-[#D3DBDF] border rounded-md py-3 px-8  text-[14px] flex items-center justify-start gap-2'> <span className='flex text-black items-center gap-2'><img src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1749508617/move-resize-variant_karpuj.png" alt="" /> Upscale</span></button>
                </div>

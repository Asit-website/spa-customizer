        ...
        <div className='bg-white rounded-lg border border-[#D3DBDF] w-80 h-fit'>
            <div className='flex items-center justify-between py-2 px-3'>
                <div className='flex items-center gap-2'>
                    ...
                    <h3 className='text-[16px] font-semibold'>Improve with AI</h3>
                </div>
            ...
            <div className='py-3 px-4'>
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='relative bg-[#E4E9EC] rounded-lg h-46'> <textarea name='description' className='p-2 resize-none w-full text-[13px] h-36 border-none focus:border-none outline-none overflow-y-scroll placeholder:text-[13px]' placeholder='Describe the design in a sentence' />
                    ...
                    <div className='my-2 flex items-center gap-3'>
                        <span className='px-5 py-1.5 text-[13px] rounded-full bg-gray-100'>Color</span>
                        <span className='px-5 py-1.5 text-[13px] rounded-full bg-gray-200 text-gray-500'>Arts</span>
                    </div>
